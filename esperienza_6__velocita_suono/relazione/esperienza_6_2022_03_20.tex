...
I due strumenti sono entrambi allineati ad una guida fissa al tavolo su cui sono anche riportati i centimetri, necessari per individuare la distanza tra la sorgente e il ricevitore. 
...
Impostiamo inizialmente la misura in modo da porre il primo cursore sul fronte di salita dell'onda quadra che genera il suono, e il secondo cursore sul primo fronte di discesa dell'onda del microfono. In questo modo in automatico lo strumento può effettuare una misura tra i due fronti. 

Lasciando fisso il ricevitore spostiamo la sorgente lungo la guida e raccogliamo misure di ($d$, $t$)

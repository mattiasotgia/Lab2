...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.75\linewidth]{plot_analog_220417.pdf}
...
Questi punti influiscono sul valore medio e sulla deviazione standard della distribuzione in modo influente, quindi decidiamo di toglierli dal calcolo. 
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.75\linewidth]{plot_digital_220417.pdf}
...
\begin{figure}
    ...
    \caption{Risultati complessivi analisi dati. Differenza sperimentale tra il valore teorico della velocità del suono \SI{343.210(338)}{\metre\per\second} e il valore misurato in laboratorio. \'E riportata anche la miglior stima del valore ottenuto in laboratorio (\SI{347.572(390)}{\metre\per\second})}
\end{figure}
\iffalse
\fi

...
\begin{align*}
    v_s &=%%\SI{3.49868e02 +- 1.03245e-01}{\metre\per\second} \\
    q &=%%\SI{1.27950e-01 +- 9.14933e-04}{\metre} \\
\end{align*}

Osserviamo quindi che i due valori del parametro $v_s$ sono compatibili e perciò possiamo ricavare la miglior stima che è pari a
\begin{align*}
    v_s(bestvalue)=\SI{348.577 +- 0.55234}{\metre\per\second}\\
\end{align*}

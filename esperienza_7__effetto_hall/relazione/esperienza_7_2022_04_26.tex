...
\begin{abstract}
    ...
    Si vuole misurare la densità di portatori di carica di una sonda di Rame [\ch{Cu29}] realizzata per deposizione su vetro. Questa permette di avere una corrente $i_s$ ed è inseribile in un traferro dove è sottoposta ad un campo $B_t$. La tensione $V_H$ è ortogonale a questi due contributi e può essere misurata direttamente.
\end{abstract}

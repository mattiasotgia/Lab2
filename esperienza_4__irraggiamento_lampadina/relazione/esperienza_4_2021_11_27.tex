...
ed effettuando 5 diverse misure del valore di $V_{out}$ per 5 diversi valori di $V_{in}$ e facendo quindi un fit secondo l'equazione $V_{out}=G_{CM}\cdot V_{in}+q$ scegliendo come parametri $G_{CM}$ e $q$ (I valori raccolti si trovano in ).

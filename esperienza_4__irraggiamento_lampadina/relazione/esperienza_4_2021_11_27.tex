...
\begin{figure}[!h]
    \raggedright
    \includegraphics[width=0.45\linewidth]{Guadagno__invertente.pdf}
    \includegraphics[width=0.45\linewidth]{Guadagno__noninvertente.pdf}
    \caption{\textbf{Analisi del guadagno degli amplificatori operazionali.} Sinistra: valori variabili di tensione in ingresso e in uscita per misurare il guadagno dello strumento, in configurazione invertente. Destra: come sopra, per la configurazione non invertente.}
...
\begin{figure}[!h]
    \raggedright
    \includegraphics[width=0.45\linewidth]{GuadagnoMC.pdf}
    \includegraphics[width=0.45\linewidth]{GuadagnoDIFF.pdf}

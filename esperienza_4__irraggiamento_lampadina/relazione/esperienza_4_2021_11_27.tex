...
Dal modello \#1 otteniamo che per ogni distanza che abbiamo selezionato l'approssimazione lineare al primo ordine funziona e otteniamo quindi 8 coppie di valori $(d,~dV/dt)$ che già visivamente mostrano un andamento compatibile con la teoria. Realizzando quindi il fit, il valore dell'esponente ottenuto è: \[exp=\num{-2.02888 +- 0.0450765}\] mentre il valore dell'offset lungo la distanza è pari a \SI{3.46169 +- 1.10637}{\centi\metre}. Perciò considerando la compatibilità entro $3\sigma$ verifichiamo che il valore dell'esponente è compatibile con quanto previsto dalla teoria mentre il valore dell'offset non è compatibile con zero pur avendo già considerato anche gli errori sistematici per cui il disassamento, su cui non siamo stati in grado di dare una stima quantitativa, non è trasucurabile, ma anzi comporta la presenza di questo offset.

...
\]
dove il fattore $p_1$ vogliamo verificare che sia compatibile con il valore atteso di -2, mentre il valore di $p_2$ rappresenta l'eventuale offset sui valori raccolti della distanza. Il parametro $p_0$ rappresenta invece la costante di proporzionalità.

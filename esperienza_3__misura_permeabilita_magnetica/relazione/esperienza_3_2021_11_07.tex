...
\begin{table}[h]
    \begin{ruledtabular}
        \caption{Valori di R, L e C ottenuti dal fit del primo modello utilizzato per il primo diagramma di Bode (funzione di trasferimento) partendo dai valori di $A$, $Q^2$ e $\nu_0$ e considerando $R_L = \SI{3.7 +- 0.25}{\ohm}$ come valore noto.}% \hl{non ho capito a cosa serve questa tabella?}}

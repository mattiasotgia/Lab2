...
\section*{Modello di fit sui parametri di costruzione del filtro}
...
\begin{table}[h]
    \begin{ruledtabular}
        ...
        \begin{tabular}{lrrr}
            ...
            \colrule
            Risultati da $\big|H\big|$ & \SI{1.87 +- 0.14}{} & \SI{1.99+-0.05}{} & \SI{2.4 +- 0.6e3}{} \\
            Risultati dalla fase  & - & - & - \\
        \end{tabular}
    \end{ruledtabular}
\end{table}

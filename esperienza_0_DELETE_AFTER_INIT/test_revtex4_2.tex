...
\usepackage[a4paper, top=1.75cm,bottom=2.5cm,left=1.5cm,right=1.5cm]{geometry}
...
\fancyhead[C]{\fontsize{12}{12}\selectfont RELAZIONE DI LABORATORIO \textbf{N. 8} (\the\year)}
